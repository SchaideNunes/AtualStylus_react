...
describe('Login Component Revamp (TDD)', () => {
  ...
  it('deve renderizar campos de email, senha e botão de entrar', () => {
    render(<Login />);
    expect(screen.getByPlaceholderText(/admin@atualestilo.com.br/i)).toBeInTheDocument();
